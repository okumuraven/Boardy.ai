...
/**
 * @title VokaziMilestoneEscrow
 * @notice AVAX escrow for deliverables between matched Vokazi.ai users.
 * @dev Payer funds milestone; payee completes work; payer releases funds.
 */
contract VokaziMilestoneEscrow is Ownable, ReentrancyGuard {
