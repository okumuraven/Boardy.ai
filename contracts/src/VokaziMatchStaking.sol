 ...
 */
contract VokaziMatchStaking is Ownable, ReentrancyGuard {
    ...
    /**
     * @notice Register a bilateral match. Called by the Vokazi backend after pgvector matching.
