...
describe("VokaziMatchStaking", function () {
  let staking;
  let owner;
  let userA;
  let userB;
  ...
  beforeEach(async function () {
    ...
    const Factory = await ethers.getContractFactory("VokaziMatchStaking");
...
describe("VokaziMilestoneEscrow", function () {
  let escrow;
  let owner;
  let payer;
  let payee;
  ...
  beforeEach(async function () {
    ...
    const Factory = await ethers.getContractFactory("VokaziMilestoneEscrow");
