  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1rem', color: 'var(--text-main)', lineHeight: '1.8' }}>
      ...
      <div className="animate-in">
        <h1 className="title whitepaper-title" style={{ marginBottom: '0.5rem', letterSpacing: '-0.03em' }}>Vokazi.ai Lightpaper</h1>
        ...
        <section style={{ marginBottom: '4rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '1.15rem' }}>
            <strong>Vokazi.ai</strong> introduces the <em>Verified Professional Synergy Protocol</em>. By combining Conversational AI, high-dimensional Vector Similarity Matching, and Web3 Smart Contracts, Vokazi.ai eliminates networking friction and mathematically guarantees high-conviction introductions.
          </p>
        </section>
